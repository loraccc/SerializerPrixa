...
SECRET_KEY = 'django-insecure-lxu%34*t!msoqty5tca+$3057fwuo-(2y+5tf*82scv@akl=+3'
...
MIDDLEWARE = [
    ...
    'restFramework.middleware.PrintProductNamesMiddleware',
    'restFramework.middleware.RandomNumMiddleware',
